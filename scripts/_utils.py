...
def score_abs(_x: np.ndarray, y: np.ndarray) -> np.ndarray:
    return np.abs(y)


def inv_score_abs(_x: np.ndarray, s: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
    return -s, s
...
def score_y(_x: np.ndarray, y: np.ndarray) -> np.ndarray:
    return y


def inv_score_y(_x: np.ndarray, s: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
